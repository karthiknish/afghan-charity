          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <motion.div className="text-center mb-16" variants={fadeIn}>
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                ...
                supporting various charitable organizations and projects
                benefiting South Asian communities, both locally in the UK and
                internationally. We believe in transparency and making a
                tangible difference.
              </p>
            </motion.div>
