    ...
    <div className="min-h-screen bg-afghan-white">
      ...
      >
        ...
        >
          ...
          >
            Discover our curated selection of South Asian clothing, accessories,
            books, art, and ethically sourced treasures.
          </motion.p>
        </motion.div>
      </motion.section>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <motion.div className="text-center mb-16" variants={fadeIn}>
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">
              ...
              produced in the developing world, supporting artisans and ethical
              practices.
            </p>
            <p className="text-lg font-semibold text-afghan-blue">
              Currently, our products are available for purchase in-store only.
              ...
              <div className="h-full bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Beautiful sarees, kurtas, shawls, and more. Discover unique
                    pieces rich in culture.
                  </p>
                </div>
              </div>
            </motion.div>
